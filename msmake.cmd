...
@rem set ltxparam=-quiet -c-style-errors
...
call xelatex %ltxparam% %thupkg%.dtx
...
call xelatex %ltxparam% %thupkg%.dtx
if errorlevel 1 goto clserr1
@rem call gbk2uni %thupkg%.out
@rem if errorlevel 1 goto clserr1
call xelatex %ltxparam% %thupkg%.dtx
